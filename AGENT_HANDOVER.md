...
**Production HEAD (code):** `866f75e` (full-width Loans pane) — prior: Members 50/50 `e57d965`, crisp type `c132206`
...
| 4w | ~~**Quieter Register + auto org code**~~ | ✅ **Done** 2026-08-29 — Name confirm, generated code, copy/save, country label only, admin/member login pre-fill. `npm run test:organization-code`. **Deploy:** `git push`. |
