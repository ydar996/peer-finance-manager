...
- **2026-07-03** — Product page section heads: removed `max-width: 640px` so headings/leads use full container width (no premature line breaks). Hero: five dashboard mock cards; mobile/tablet grid shows all cards. **Production:** `git push`.
