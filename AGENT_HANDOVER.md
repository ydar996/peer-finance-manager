...
- **2026-07-03** — Product page hero: five dashboard mock cards (was three); mobile/tablet uses a grid so all cards show (Members was missing on mobile due to absolute positioning). **Production:** `git push`.
