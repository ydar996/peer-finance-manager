...
**Last updated:** July 16, 2026 (membership status + document upload; last deploy `971717e`)  
...
| 4q | ~~**Membership status by type (resign/death/expel/suspend)**~~ | ✅ **Done** 2026-07-16 — Typed status; hide from active list; keep ledger; exclude from emails; portal login off; PDF/image notice upload + download. `npm run test:membership-status`. **Deploy:** `git push`. |
