...
- **2026-07-06** — **Member report PDF UI cache fix:** Netlify build cache-busts `app.js`/`styles.css`; no-cache headers. Report rows show **VIEW PDF REPORT** card; full-screen viewer (`z-index` 5000) with Back/Download. **Production:** `git push`.
