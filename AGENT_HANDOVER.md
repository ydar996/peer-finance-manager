...
- **2026-07-03** — **Cooperative** capitalization applied app-wide (UI, emails, PDF reports, bylaws seed v11, docs). Product page polish (trust cards, title case, footer). **Production:** `git push`; Render restart re-seeds bylaws v11.
