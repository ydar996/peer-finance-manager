...
| 4s | ~~**Cooperative inbox messaging (all tenants)**~~ | ✅ **Done** 2026-07-17 — Inbox + unread; **rich Word-paste composer** + PDF/image/Word attachments. `npm run test:messaging`. **Deploy:** `git push`. |
