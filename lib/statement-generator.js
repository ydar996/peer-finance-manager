...
function parseWorkbook(workbookPath, sheetName) {
  ...
  for (const y of years) {
    detailRows.push({ type: "yearTotal", year: y, label: `Total Contributions ${y}` });
  }
  ...
  for (let m = 0; m <= statementMonthIndex; m++) {
    detailRows.push({
      ...
      year: statementYear,
      month: MONTH_NAMES[m],
      label: `${MONTH_NAMES[m]} ${statementYear} Contribution`,
    });
      ...
      <section class="panel statement">
        ...
        <div class="summary-grid">
          <div class="summary-card">
            <p class="label">Total Contributions to Date</p>
          ...
          ${years
            .map(
              (y) => `
          <div class="summary-card">
            <p class="label">Total Contributions ${y}</p>
          ...
          <div class="summary-card">
            <p class="label">${statementMonthName} ${statementYear} Contribution</p>
